...
% Randomly divide the quarter 2 data into training and testing data
...
train_idxs = perm(1:qt2train_size);     % Use the first qt1train_size samples as training data
...
% How well would I do using quarter 1 model?
[qt2profit, qt2roi] = performStockSVM(qt2train_x, qt2train_y, qt2test_x, qt2test_y, amountPerWager);
...
[xQtProfit, xQtRoi] = performStockSVM(qt1on2train_x, qt1on2train_y, qt1on2test_x, qt1on2test_y, amountPerWager);
